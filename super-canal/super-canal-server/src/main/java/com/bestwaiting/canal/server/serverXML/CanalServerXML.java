package com.bestwaiting.canal.server.serverXML;
 ...
 */
public class CanalServerXML {
    private static final Log logger = LogFactory.getLog(CanalServerXML.class);
        ...
        try {
            ...
            for (String conf : configs) {
                if (conf.startsWith(CLASSPATH_URL_PREFIX)) {
                    ...
                    properties.load(CanalServerXML.class.getClassLoader().getResourceAsStream(conf));
                } else {
